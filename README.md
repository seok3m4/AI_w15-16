...
4. 홈 화면에서 날짜와 팀을 선택해 KBO 공식 경기 일정/결과를 조회합니다.
5. MCP 패널에서 야구 키워드 또는 뉴스 URL로 브리핑을 생성합니다.
6. Agent 패널에 짧은 경기 메모를 입력해 추천 제목, 태그, 리뷰 초안, 체크리스트를 생성합니다.
7. 생성된 초안을 바탕으로 게시글을 작성하고 댓글을 남깁니다.
